pro ncounts_lbin_bin ;declares program
...
;4 - binary hmg to get black hole mass too
      ...
      test1=FILE_TEST("/astro/store/gradscratch/tmp/tzdw/BPASS/binaries/"+dum) ;Check if file exists.
                                ;   print,dum,test1
      if(test1 eq 1) then begin
         openr,6,"/astro/store/gradscratch/tmp/tzdw/BPASS/binaries/"+dum ;Open model into filenumber 6
   ...
   openw,5,"~/ncounts_binary_49"+znames(zn)+".dat"
